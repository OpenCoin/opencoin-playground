...
- WeightedURLList: A list of 2 element tuples \[Int, URL\].  Useful for round-robin, but also 
  reflects a preference. The lower the weight value, the higher the priority.
...
of the key in the wallet (client software).
...
The format is: SIGN-HASH-PADDING-BLINDING, e.g. [RSA-SHA256-PSS-CHAUM82](operations.md#rsa-sha256-pss-chaum82).
